...
CELERY_DEFAULT_EXCHANGE = 'lms'
CELERY_DEFAULT_EXCHANGE_TYPE = 'direct'

# Queues configuration

HIGH_PRIORITY_QUEUE = 'lms.tasks.high'
DEFAULT_PRIORITY_QUEUE = 'lms.tasks.default'
LOW_PRIORITY_QUEUE = 'lms.tasks.low'
...
CELERY_DEFAULT_ROUTING_KEY = 'lms.task'
